...
function init() {
  if (!mpHands.Hands || !controls.ControlPanel || !controls3d.LandmarkGrid) {
    showError(
      'MediaPipe scripts failed to load. Check your network or open the demo in a new tab.',
    );
    return;
  }
  ...
  const controlsElement = document.querySelector('.control-panel-mount');
